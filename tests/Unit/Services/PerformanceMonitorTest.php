...
class PerformanceMonitorTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        Config::set('filex.monitoring.enable_metrics', true);
        Config::set('filex.monitoring.log_performance', false);
        Config::set('filex.optimization.cache_ttl', 3600);
    ...
    {
        // Disable metrics
        Config::set('filex.monitoring.enable_metrics', false);
    ...
    {
        Config::set('filex.monitoring.log_performance', true);
