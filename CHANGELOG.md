...
* chore(deps): Bump aglipanci/laravel-pint-action from 2.5 to 2.6 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-filex/pull/3
* chore(deps): Bump actions/checkout from 4 to 5 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-filex/pull/4
* chore(deps): Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-filex/pull/7
* feat: add SKILL.md for Filex async file upload system documentation by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-filex/pull/8
* chore(deps): Bump stefanzweifel/git-auto-commit-action from 6 to 7 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-filex/pull/5
* chore(deps): Bump actions/checkout from 5 to 6 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-filex/pull/6

### New Contributors

* @dependabot[bot] made their first contribution in https://github.com/DevWizardHQ/laravel-filex/pull/3
