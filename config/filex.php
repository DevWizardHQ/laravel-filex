...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Configure the disk storage settings for file uploads and temporary files.
    |
    */
    'storage' => [
        'disks' => [
            'default' => env('FILEX_DISK', config('filesystems.default', 'public')),
            'temp' => env('FILEX_TEMP_DISK', 'local'),
        ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configure allowed file extensions, MIME types, and validation settings.
    |
    */
    'validation' => [
        'allowed_extensions' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for file upload behavior including chunked uploads.
    |
    */
    'upload' => [
        'chunk' => [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for system maintenance and cleanup operations.
    |
    */
    'system' => [
        'cleanup' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Settings to optimize performance for large file uploads and processing.
    |
    */
    'performance' => [
