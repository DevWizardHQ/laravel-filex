...
@if(config('filex.optimization.lazy_loading', true))
    {{-- Lazy load assets for better performance --}}
    <link rel="preload" href="{{ asset('vendor/filex/css/dropzone.min.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('vendor/filex/css/filex.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
